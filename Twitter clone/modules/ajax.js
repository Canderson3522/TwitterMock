import { getRandomInt, createGuid } from "./helpers.js";
import { displayPosts } from "./posts.js";
import { currentUser } from "./users.js";

const baseUrl = 'https://fed-2110-twitter-clone-default-rtdb.firebaseio.com/';
const ext = '.json';
...
export function loginUser(callback) {
    $.get({
        ...
        success: (response) => {
            ...
            const allUsers = response.filter((users) => !!users);
